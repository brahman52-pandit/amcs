...
// Populate student list with highlighting
function populateStudentList() {
    ...
    students.forEach(student => {
        ...
        row.innerHTML = `
            ...
            <td>${student.name}</td>
            <td>
                <select class="status-select" name="status_${student.rollNo}" onchange="updateRowStyle(this)">
...
function updateRowStyle(element) {
    ...
    // Add appropriate class based on status and remark
    if (status === 'absent') {
...
document.getElementById('attendanceForm').addEventListener('submit', function(e) {
    ...
    students.forEach(student => {
        const status = document.querySelector(`select[name="status_${student.rollNo}"]`).value;
